...
df_land_own_status <- tibble(phase = c("Baseline", "Endline", "Baseline", "Endline", "Baseline",
                      ...
                      perc_respondents = c(23, 18, 49, 44, 12, 7, 0, 31, 16, 0),
                      Status = c("Rented", "Rented", "Owned", "Owned", "Borrowed",
...
df_land_acquisition %>% 
  ggplot(aes(fill = phase, x= fct_reorder(method, -perc_respondents), y= perc_respondents)) +
  geom_bar(position = "dodge", stat = "identity") +
...
df_tillage_cost %>% 
  ggplot(aes(fill = phase, x= fct_reorder(category, -perc_respondents), y= perc_respondents)) +
  geom_bar(position = "dodge", stat = "identity") +
...
df_tillage_finance_source <- tibble(phase = c("Baseline", "Endline", "Baseline", "Endline", "Baseline",
                              ...
                              finance_source = c("Sale of crops", "Sale of crops", "Sale of foof aid", "Sale of foof aid", "Casual labour",
...
df_tillage_finance_source %>% 
  ggplot(aes(fill = phase, x= fct_reorder(finance_source, -perc_respondents), y= perc_respondents)) +
  geom_bar(position = "dodge", stat = "identity") +
...
df_farming_information_source %>% 
  ggplot(aes(fill = phase, x= fct_reorder(information_source, -perc_respondents), y= perc_respondents)) +
  geom_bar(position = "dodge", stat = "identity") +
...
df_cost_share_sources <- tibble(phase = c("Baseline", "Endline", "Baseline", "Endline", "Baseline",
                             ...
                             cost_share_source = c("Sale of crops", "Sale of crops", "Sale of food aid", "Sale of food aid", "Casual labour",
                                                    ...
                                                    "Petty trade and commerce", "Cash aid", "Cash aid", "Remittances", "Remittances")
                                       )
                                                    
df_cost_share_sources%>% 
  ggplot(aes(fill = phase, x= fct_reorder(cost_share_source, -perc_respondents), y= perc_respondents)) +
  geom_bar(position = "dodge", stat = "identity") +
...
df_agronomy_management <- tibble(Settlements = c("Bidibidi", "Bidibidi","Bidibidi","Bidibidi",
...
df_agronomy_management %>% 
  ...
  labs(title = paste("Gender distribution of trained farmers by community type in the three locations")) +
  scale_fill_manual(values = c("#303434", "#00aeef"))+
  theme_bw() +
  theme(text= element_text(size= 12), legend.title= element_blank(), 
        panel.grid.major.y = element_blank(), panel.grid.major.x = element_blank(), 
...
df_extension_service_type <- tibble(phase = c("Baseline", "Endline", "Baseline", "Endline",
                                      ...
                                      extension_service_type = c("Improved farming practices", "Improved farming practices", 
                                                                   ...
                                                                   "Contro of weeds, pests and diseases", "Contro of weeds, pests and diseases",
                                                                   "Climate Smart Agriculture", "Climate Smart Agriculture")
                                                          )
df_extension_service_type %>% 
  ggplot(aes(fill = phase, x= fct_reorder(extension_service_type, -perc_respondents), y= perc_respondents)) +
  geom_bar(position = "dodge", stat = "identity") +
...
df_ICs <- tibble(phase = c("Baseline", "Endline", "Baseline", "Endline",
                                    ...
                                    innovation_center_services = c("Farming as a business", "Farming as a business", 
                                                               ...
                                                               "Online teaching", "Online teaching", "Tailoring", "Tailoring",
...
df_ICs %>% 
  ggplot(aes(fill = phase, x= fct_reorder(innovation_center_services, -perc_respondents), y= perc_respondents)) +
  geom_bar(position = "dodge", stat = "identity") +
  scale_fill_manual(values = c("#303434", "#00aeef"))+
    theme_bw() +
  theme(text= element_text(size= 12), legend.title= element_blank(), 
...
df_ICs_visit_freq %>% 
  ggplot(aes(fill = phase, x= fct_reorder(ICs_visit_freq, -perc_respondents), y= perc_respondents)) +
  geom_bar(position = "dodge", stat = "identity") +
    scale_fill_manual(values = c("#303434", "#00aeef"))+
  theme_bw()+
  theme(text= element_text(size= 12), legend.title= element_blank(), 
...
df_women_limit_agric_services %>% 
  ggplot(aes(fill = phase, x= fct_reorder(women_limit_agric_services, -perc_respondents), y= perc_respondents)) +
  geom_bar(position = "dodge", stat = "identity") +
  scale_fill_manual(values = c("#303434", "#00aeef"))+
  theme_bw()+
  theme(text= element_text(size= 12), legend.title= element_blank(), 
